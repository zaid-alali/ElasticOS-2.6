...
ssh -t -t root@$EOS_REMOTE_MACHINE << HERE
	cd /home/ehab/Desktop/elasticos-2.6/misc/nbd-2.9.16/
...
ssh -t -t root@$EOS_REMOTE_MACHINE << HERE
	cd /home/ehab/Desktop/elasticos-2.6/misc/get_put_pg_impl
	insmod ./gppi.ko
	cd /home/ehab/Desktop/elasticos-2.6/misc/eos-nbd/nbd-kmod/ 
	insmod ./eosnbd.ko 
	cd ../eos-pager/dist/Debug/GNU-Linux-x86/ 
	./eos-pager \$EOS_REMOTE_MACHINE 1043 /dev/eosnbd1 
	mkswap -f /dev/eosnbd1 
