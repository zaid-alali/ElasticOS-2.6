...
asmlinkage long sys_inject_page(int, unsigned long, unsigned int, const char *);
asmlinkage long sys_get_page(int, unsigned long, unsigned int, const char *);
asmlinkage long sys_sticky_process(int);
asmlinkage long sys_unsticky_process(int);
